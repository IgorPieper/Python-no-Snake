...
fpr_clf_1, tpr_clf_1, _ = roc_curve(y_test, probs_clf_1)
roc_auc_clf_1 = auc(fpr_clf_1, tpr_clf_1)

# clf_2
probs_clf_2 = clf_2.predict_proba(X_test)[:, 1]
fpr_clf_2, tpr_clf_2, _ = roc_curve(y_test, probs_clf_2)
roc_auc_clf_2 = auc(fpr_clf_2, tpr_clf_2)

# Drawing ROC
plt.figure()
plt.plot(fpr_clf_1, tpr_clf_1, color='darkorange', lw=2, label=f'ROC curve (area = {roc_auc_clf_1:.2f}) for clf_1')
plt.plot(fpr_clf_2, tpr_clf_2, color='blue', lw=2, label=f'ROC curve (area = {roc_auc_clf_2:.2f}) for clf_2')
