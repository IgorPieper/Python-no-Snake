...
precision_1, recall_1, _ = precision_recall_curve(y_test, probs_clf_1)

# clf_2
probs_clf_2 = clf_2.predict_proba(X_test)[:, 1]
precision_2, recall_2, _ = precision_recall_curve(y_test, probs_clf_2)

# Drawing Precision-Recall
plt.figure(figsize=(10, 7))
plt.plot(recall_1, precision_1, label='clf_1', color='blue')
plt.plot(recall_2, precision_2, label='clf_2', color='red')
plt.xlabel('Recall')
